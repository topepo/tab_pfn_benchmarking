...
for noise_cols in noise_seq:
    ...
    pred_time = {"num_cols": te_noise.shape[1], "time": pred_time, "gpu": "cuda"}
...
all_times.to_csv("predictions_by_num_cols_times_cuda.csv", index=False)
